...
inputs_rows = [
    ...
    ("Risk-free rate (10Y UST)", risk_free_rate, "Tune to current yield as of valuation date.", PCT, "input"),
    ("Equity risk premium (mature US)", equity_risk_premium, "Implied ERP; refresh quarterly from a standard source.", PCT, "input"),
    ("Levered beta", beta, "Bottom-up: weighted avg of segment betas if multi-business.", '0.00', "input"),
    ("Pre-tax cost of debt", pretax_cost_of_debt, "rf + spread implied by credit rating.", PCT, "input"),
    ...
    ("Compounded revenue growth, Y1-Y5", revenue_growth_y1_5, "Glide path to terminal. Tune for thesis.", PCT, "input"),
    ("Target pre-tax operating margin (Y10)", target_op_margin, "Year-10 EBIT margin; current margin is the start.", PCT, "input"),
    ("Year margins reach target", year_of_convergence, "Linear convergence over this many years.", '0', "input"),
    ("Sales-to-capital ratio (reinvestment)", sales_to_capital, "Reinvestment = ΔRevenue / S2C. Lower = more capital intensive.", MULT, "input"),
    ("", None, None, None, None),
    ("— Terminal-year assumptions —", None, None, None, None),
    ("Terminal growth rate (perpetuity)", terminal_growth, "Capped at risk-free rate.", PCT, "input"),
    ("Terminal cost of capital", terminal_cost_of_capital, "Converges to mature-firm WACC.", PCT, "input"),
    ("Terminal ROIC", terminal_roic, "Sustainable competitive return.", PCT, "input"),
    ("", None, None, None, None),
